...
class OthersRegistration extends StatefulWidget {
  static final id = 'student_registration';
  @override
  _OthersRegistrationState createState() => _OthersRegistrationState();
}

class _OthersRegistrationState extends State<OthersRegistration> {
...
//                          Colors.red),),
            ...
            TextFormField(
              ...
              decoration: Styles.flatFormFields.copyWith(labelText: 'ADDRESS',focusColor: Colors.pink),
              // The validator receives the text that the user has entered.
              validator: (value) {
                //email = value.trim();
...
//
  ...
  */
  ...
  bool validateSteps(){
    ...
    //print(stepKeyMapping[currentStep].currentState.validate());
  ...
  */
  next() {
    print(formValidationComplete());
    if(currentStep==2 && formValidationComplete()) submit() /*print(currentStep)*/;
  validateSteps() ?
