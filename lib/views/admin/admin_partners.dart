...
class AdminPartners extends StatefulWidget {
  @override
  _AdminPartnersState createState() => _AdminPartnersState();
}

class _AdminPartnersState extends State<AdminPartners> {
                      ...
                      Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Expanded(flex:7, child: Row(
                              children: <Widget>[
                                Flexible(child: Text('${data.partners[index].nameOfBusiness}',overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.grey[600]),))
                              ],
                            )),
                            Expanded(flex:4, child: Row(
                              children: <Widget>[
