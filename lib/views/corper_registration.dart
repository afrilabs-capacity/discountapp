...
class CorperRegistration extends StatefulWidget {
  @override
  _CorperRegistrationState createState() => _CorperRegistrationState();
}

class _CorperRegistrationState extends State<CorperRegistration> {
  ...
  TextEditingController nyscCallupNumberController = TextEditingController();
  TextEditingController ppaController = TextEditingController();
  ...
  Future <void> submit() async {
    if (formValidationComplete()) {
      ...
      response = await Provider.of<AuthProvider>(context)
          ...
          nyscCallupController:nyscCallupNumberController.text,
          ppaController:ppaController.text,
          passwordController:passwordController.text,
          passwordConfirmController:passwordConfirmController.text,
          cardHolderController:'corper'
      );
      if (response['success']) {
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (context) => UploadPassport()));
      } else {
...
//
            ...
            SizedBox(height: 10.0,),
            TextFormField(
              controller: nyscCallupNumberController,
              decoration: Styles.flatFormFields.copyWith(labelText: 'NYSC Call up Number',focusColor: Colors.pink,),
              // The validator receives the text that the user has entered.
              validator: (value) {
                //email = value.trim();
                return Validate.requiredField(value,'NYSC Call up Number required');
              },
              //style: TextStyle(fontWeight: FontWeight.w100,color: Colors.black),
            ),
            ...
            TextFormField(
              ...
              decoration: Styles.flatFormFields.copyWith(labelText: 'Place of Primary Assignment',focusColor: Colors.pink,),
              // The validator receives the text that the user has entered.
              validator: (value) {
                //email = value.trim();
                return Validate.requiredField(value,'Place of Primary Assignment required');
              },
              //style: TextStyle(fontWeight: FontWeight.w100,color: Colors.black),
            ),
          ],
...
//
  ...
  */
  ...
  void initState() {
    ...
    firstNameController.text = "Joshua";
    middleNameController.text = "Paul";
    ...
    emailController.text = "canivatimes@gmail.com";
    phoneController.text = "07036066056";
    instituteSchoolController.text = "Benue State University";
    nyscCallupNumberController.text = "GYGSFET/33737";
    ppaController.text= "Voice of Nigeria";
  ...
  */
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Text('Youth Corp Registration!!',style: TextStyle(color:Colors.white,fontSize: 25.0),),
                        ],
                      ),
                    ),
                  ),
  ...
  void dispose() {
    ...
    nyscCallupNumberController.dispose();
    ppaController.dispose();
